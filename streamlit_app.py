...
try:
    ...
    with tab2:
        ...
        modelo = modelo[['Marca_modelo', 'MarcaModelo_modelo', 'Precio','Precio_median','Kilometraje','KM_median','Año','Precio_count','nota_final','factor_marca','factor_precio','factor_año','factor_km','factor_extras']]
